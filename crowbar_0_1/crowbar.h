...
ArgumentList *crb_chain_argument_list(Argument *list, Expression *expr);
...
Expression *crb_create_null_expresison(CRB_Boolean value);
Expression *crb_create_global_statement(IdentifierList *identifier_list);
...
Statement *crb_create_if_statement(Expression *conditiion,
...
Block *crb_create_block(StatementList *statement_list);A
Statement *crb_create_expression_statement(Expression *expression);
Statement *crb_create_expression_return_statement(Expression *expression);
